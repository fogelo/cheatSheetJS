...
//контекст можно подменять  методы call, applay, bind


/* 
?1. что значит у стрелочных функций нет собственного this?
?2. что такое this? что такое scope? что такое лексическое окружение? что такое замыкание? что такое область видимости? что такое контенск выполнения(вызова)?
