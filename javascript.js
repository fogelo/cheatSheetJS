...
ECMAScript - это снадарт, на котором основан js, его часто называют ES

ES5 - фундаментальная версия стандарта ECMAScript, разрабатывался 10 лет. Был выпущен в 2009 году.
...
5) Шаблонные строки
6) Параметры по умолчанию в функциях
7) Синтаксис Spread/Rest
8) Symbol
9) Цикл for ... of
10) Классы
11) Модули (импорт и экспорт)
12) Можно не указывать ключ, если свойство называется так же. 
13) Новые методы
...
?ES2022
1) Можем теперь обращаться к элементам массива с конца (тоже самое и со строками теперь)
const arr = [1,2,3,4]
НЕ так arr[arr.length - 2] // 3 а вот так теперь arr.at(-2) // 3




@ - статься про стандарты языка https://jetblackcodes.medium.com/полный-разбор-ecmascript-2015-2016-2017-2018-2019-2020-2021-3e7263924a5f
