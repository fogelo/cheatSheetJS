...
//forEach(..), every(..) и some(..). Каждая вспомогательная функция получает функцию обратного вызова, которая будет применена к каждому элементу массива;
// различается только реакция на возвращаемое значение функции обратного вызова. 
