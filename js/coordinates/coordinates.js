...
//Внешние и внутренние метрики элементов на странице
...
//div.offsetTop - это расстояние от границы блока до его родительского элемента относительно которого он спозиционарован
